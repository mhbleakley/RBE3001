...
shiftVec = [0.024403 -0.009464 0.411362];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-0.855031 0.261231 0.000000 0.359735;
    -0.216948 -1.002541 0.138518 0.519728;
    -0.035613 -0.164572 -0.843821 9.252262;
...
hPoints(1).data = [-0.065913 0.384577;
    0.016549 0.054651;
    0.217852 0.313027;
    0.026250 0.412403];

% Define each manually generated ROI
hPoints(2).data = [-0.044085 0.416378;
    -0.070764 0.161977;
    0.038377 0.070551];
