...
shiftVec = [0.024732 -0.005577 0.388253];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-0.780861 0.386634 -0.000000 0.266473;
    0.129847 0.361671 0.755923 -0.717791;
    -0.302540 -0.842684 0.324434 9.064937;
...
hPoints(1).data = [-0.126251 -0.161137;
    -0.011435 -0.437371;
    0.095553 -0.328552];

% Define each manually generated ROI
hPoints(2).data = [-0.016654 -0.408074;
    -0.100157 -0.362035;
    -0.141908 -0.127654;
    0.051192 -0.315996];
